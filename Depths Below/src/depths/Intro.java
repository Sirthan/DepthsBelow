...
public class Intro {
public static String version= "Early Alpha 1.2.2"; //Just here to make it easier on me to change the version number easier.
	public static void main (String[] args){	
		...
		while (key){
			...
			if(choice.equalsIgnoreCase("New Game")||choice.equalsIgnoreCase("NewGame")||choice.equalsIgnoreCase("NewG")||choice.equalsIgnoreCase("NGame")||choice.equalsIgnoreCase("NG")||choice.equalsIgnoreCase("N")){
				...
				System.out.println("   Version " + version);
				System.out.println(">5 new items added!! \n>Minor bug fixes.");
